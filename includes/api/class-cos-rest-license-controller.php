<?php
/**
 * Class COS_REST_License_Controller
 *
...
class COS_REST_License_Controller extends COS_REST_Controller_Base {
	...
	public function register_routes(): void {
		...
		if ( class_exists( 'Tyche_COS_Tracking' ) ) {
			Tyche_COS_Tracking::register_settings();
		}
	}
