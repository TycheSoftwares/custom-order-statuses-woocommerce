...
=== Usage Tracking in Custom Order Status ===
...
* Plugin settings
* List of all custom statuses
* Number of orders belonging to each custom status.
* Statuses for which emails are sent
* Email settings
...
[Custom Order Status Usage Tracking](https://www.tychesoftwares.com/docs/docs/custom-order-status-for-woocommerce/custom-order-status-usage-tracking/)
